...
public class HourlyWeatherBox {
  ...
  public HourlyWeatherBox(int width, int height, LocationDataService locationDataService) {
    this.width = width;
    this.height = height;
  ...
  public HBox getContent() {
    ...
    hourlyWeatherStack.setPrefWidth((width - 180) / 8);
    ...
    hourlyPos.setPrefWidth((width - 180) / 8);
    ...
    hourlyWind.setPrefWidth((width - 180) / 8);
